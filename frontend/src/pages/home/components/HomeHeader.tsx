...
const HomeHeader: React.FC<HomeHeaderProps> = ({
  ...
  <header className="relative z-[30] bg-white/75 backdrop-blur-xl border-b border-white/60 shadow-[0_20px_60px_-35px_rgba(15,23,42,0.45)]">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex items-center justify-between gap-6 py-6">
        <div className="flex items-center gap-4">
          <button
            onClick={onToggleHamburgerMenu}
            className="p-2 rounded-xl border border-transparent hover:border-primary-100 hover:bg-primary-50/60 text-primary-600 transition-all duration-300"
          >
